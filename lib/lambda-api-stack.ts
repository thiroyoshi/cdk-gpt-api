...
export class LambdaAPIStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    gptImage.addMethod(
      "POST",
      new apigateway.LambdaIntegration(gptImageHandler),
      {
        apiKeyRequired: true,
      }
    );
    ...
    const gptImageBoardingPassHandler = new lambda.NodejsFunction(
      this,
      "gptImageBoardingPassHandler",
      {
        entry: "lambda/gpt.ts",
    ...
    gptImageBoardingPass.addMethod(
      "POST",
      new apigateway.LambdaIntegration(gptImageBoardingPassHandler),
      {
        apiKeyRequired: true,
      }
    );
    ...
    // POST map/choices
    const mapChoicesHandler = new lambda.NodejsFunction(
      this,
      "mapChoicesHandler",
      {
        entry: "lambda/map.ts",
    ...
    mapChoices.addMethod(
      "POST",
      new apigateway.LambdaIntegration(mapChoicesHandler),
      {
        apiKeyRequired: true,
      }
    );
    ...
    // GET map/directions
    const getMapDirectionsHandler = new lambda.NodejsFunction(
      this,
      "mapDirectionsHandler",
      {
        entry: "lambda/map.ts",
    ...
    mapDirections.addMethod(
      "GET",
      new apigateway.LambdaIntegration(getMapDirectionsHandler),
      {
        apiKeyRequired: true,
      }
    );
    ...
    const getDirectionDescriptionHandler = new lambda.NodejsFunction(
      this,
      "mapDirectionDescriptionHandler",
      {
        entry: "lambda/map.ts",
    ...
    mapDirectionsChat.addMethod(
      "GET",
      new apigateway.LambdaIntegration(getDirectionDescriptionHandler),
      {
        apiKeyRequired: true,
      }
    );
